...
//		env= new Environment(ENVtype.DOROGOVTSEV_T,4,null);
//		env=new Environment("ressources/map2017-2","ressources/map2017-config-1.txt");
		env=new Environment("ressources/map2018.txt"
				,"ressources/map2018-multiType-exam.txt");
