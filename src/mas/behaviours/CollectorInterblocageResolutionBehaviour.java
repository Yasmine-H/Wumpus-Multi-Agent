...
public class CollectorInterblocageResolutionBehaviour extends Behaviour{
	...
	public CollectorInterblocageResolutionBehaviour(final mas.abstractAgent myAgent, Graph graph, ACLMessage interblocageMessage, StringBuilder moveTo) {
		super(myAgent);
		this.graph = graph;
